...
export async function GET(request) {
  ...
  try {
    ...
    console.error("Erro ao buscar boletos (API Route):", error.message);
    return NextResponse.json(
      { error: error.response?.data?.error || "Erro ao carregar boletos" },
...
export async function POST(request) {
  ...
  try {
    ...
    console.error("Erro ao criar boleto (API Route):", error.message);
    return NextResponse.json(
